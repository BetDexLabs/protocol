...
impl CrossPrice {
    pub fn new(size: usize) -> CrossPrice {
        CrossPrice {
            all: Decimal::ONE,
    ...
    pub fn add(&mut self, price: f64) {
        ...
        self.all = self.all.mul(price_decimal);
...
mod test {
    ...
    fn test_cross_price_2way() {
        ...
        let mut cross_price = CrossPrice::new(market_outcomes_count);
    ...
    fn test_cross_price_4way() {
        ...
        let mut cross_price1 = CrossPrice::new(market_outcomes_count);
        cross_price1.add(4.0_f64);
        cross_price1.add(4.0_f64);
        cross_price1.add(4.0_f64);
        assert_eq!(4.0_f64, cross_price1.result().unwrap());

        let mut cross_price2 = CrossPrice::new(market_outcomes_count);
